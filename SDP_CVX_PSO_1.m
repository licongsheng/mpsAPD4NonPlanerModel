...
options = optimoptions('particleswarm','DisplayInterval',1,'Display','iter','MaxStallIterations',10,'FunctionTolerance',1e-6);
...
% save(['PSO_SDR_22_patch_',num2str(A_area*1e-2),'cm2_ra.mat'],'APDs','APD_infos','times');
